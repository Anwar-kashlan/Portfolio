...
const DotGroup = ({ selectedPage, setSelectedPage }) => {
  const selectedStyles = `relative bg-secondary-highlight before:absolute before:w-6 before:h-6 before:rounded-full
    before:border-2 before:border-secondary-highlight before:left-[-50%] before:top-[-50%]`;
